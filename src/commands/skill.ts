...
export function registerSkillCommand(program: Command): void {
  ...
  // agent-inc skill add-file <skill-name> <file-path>
  skillCmd
  ...
  // agent-inc skill edit-file <skill-name> <file-path>
  skillCmd
